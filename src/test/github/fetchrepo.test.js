...
import { fetchGithubRepoDetails, fetchGithubRepoTree, fetchGithubRepoFile } from "@/github/fetchrepo.js";
...
describe("fetchGithubRepoTree", () => {
    it("should fetch single full file tree structure", async () => {
        ...
        const result = await fetchGithubRepoTree("octocat", "Hello-World", "7fd1a60b01f91b314f59955a4e4d4e80d8edf11d", "");
